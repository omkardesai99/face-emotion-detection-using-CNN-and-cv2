...
emotion_model_info = emotion_model.fit_generator(train_generator,steps_per_epoch=28709 //64 ,epochs=3,validation_data=validation_generator, validation_steps=7178 // 64)

emotion_model.save_weights('C:\Users\omkar desai\OneDrive\Desktop\Artificial Inteligence\emotion detection\emtion_model.h5')

emotion_model.load_weights('C:\Users\omkar desai\OneDrive\Desktop\Artificial Inteligence\emotion detection\emtion_model.h5'')
...
while True:
    ...
    if(ret==True and frame is not None):
        bounding_box = cv2.CascadeClassifier(r'C:\Users\omkar desai\OneDrive\Desktop\Artificial Inteligence\opencv-master\opencv-master\data\haarcascades\haarcascade_frontalface_default.xml')
        ...
        for (x, y, w, h) in num_faces:
            ...
            cv2.putText(frame, emotion_dict[maxindex], (x+20, y-60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 114, 255), 2, cv2.LINE_AA)
